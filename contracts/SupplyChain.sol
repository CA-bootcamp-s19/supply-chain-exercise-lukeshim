...
//VARIABLE NAME
  ...
  */
  mapping (uint => Item) public items; //WHY I vs i
//VARIABLE (KEY=>VALUE) NAME
...
//VARIABLE NAME () nothing in brackets? why _;???
  ...
  //   items[_sku].buyer.transfer(amountToRefund);
  // }
//ITEMS[_SKU].BUYER.TRANSFER <-- logic???
...
//ITEMS[_SKU].STATE and State.Item (<-- logic??? and why is "Item" with uppercase?
